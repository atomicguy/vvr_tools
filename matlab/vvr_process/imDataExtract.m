function [ image_card, image_pair, image_left, image_right, card_gray, sliceBW, comboXstrip, xplot, xpeaks, smooth_plot, yplot, y_cut_peaks] = imDataExtract( image_path )
...
%stereocard
    ...
    switch x_case
        case 'already_cropped'
            ...
            [~,partA,partB,bias_term,smooth_plot] = pickJustXpeaks(stereocard, cropYCbCr);
        ...
        case 'needs_crop'
            ...
            try
                [xpoints, partA, partB, bias_term, smooth_plot, x_plotline] = pickJustXpeaks(stereocard, cropYCbCr);
                comboXstrip = mat2gray(imadd(partA,partB));
                xpeaks = x_plotline;
            catch
    ...
    switch y_case
        ...
        case 'needs_crop'
            try
               [ypoints, iflip, y_cut_peaks, bias_term] = pickJustYpeaks(stereocard, cropYCbCr);
               try
                yplot = print(plotOnImage(iflip,y_cut_peaks,bias_term),'-RGBImage');
            catch
            end
