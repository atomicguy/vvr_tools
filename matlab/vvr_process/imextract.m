function [ image_card, image_pair, image_left, image_right, card_gray, sliceBW, comboXstrip, xplot, smooth_plot, yplot, y_cut_peaks] = imextract( image_path )
...
%             smooth_plot = bias_term;
        ...
        case 'needs_crop'
            ...
            try
                [xpoints, partA, partB, bias_term, smooth_plot] = pickJustXpeaks(stereocard, cropYCbCr);
                comboXstrip = mat2gray(imadd(partA,partB));
            catch
